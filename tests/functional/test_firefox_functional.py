...
from tests.settings import USER1_EMAIL, USER1_PASSWORD, USER1_STATUS, USER2_EMAIL, USER2_PASSWORD, USER2_STATUS,\
    NEWS1_CATEGORY, NEWS1_TITLE, NEWS1_CONTENT, NEWS1_STATUS
...
class FirefoxFunctionalTestCases(StaticLiveServerTestCase):
    ...
    def test_login_form(self):
        ...
        element_to_find = self.driver.find_element_by_css_selector('div.index-welcome-title h1')
        # Check that the chosen tag contains a text that is only found on the home page
        self.assertEqual(element_to_find.text, 'Bienvenue sur le site de notre copropriété')
    ...
    def test_homepage_to_news(self):
        ...
        # To know if we have been redirected to the news page after clicking on the link, look for a specific tag for this page
        element_to_find = self.driver.find_element_by_css_selector('div.page-title-block h1')
    ...
    def test_contact_form(self):
        ...
        # To know if we have been redirected to the contact success page after submit, look for a specific tag for this page
        element_to_find = self.driver.find_element_by_class_name('contact-success-msg')
        # We check that the chosen tag contains a text that is only found on the contact success page
