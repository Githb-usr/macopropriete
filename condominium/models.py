...
class Condominium(models.Model):
    ...
    """
    condominium_type = models.CharField(max_length=30, choices=CONDOMINIUM_TYPE, verbose_name='Type')
    name = models.CharField(max_length=30, verbose_name='Nom')
    number = models.CharField(max_length=10, null=True, blank=True, verbose_name='Numéro')
    description = models.TextField(null=True, blank=True, verbose_name='Description')
    share = models.CharField(null=True, blank=True, max_length=15, verbose_name='Quote-part')
...
class Entrance(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, upload_to='condominium/condominium/')
    uuid = models.UUIDField(default=uuid.uuid4, unique=True, verbose_name='UUID')
    building = models.ForeignKey(Building, on_delete=models.CASCADE, related_name='building_of_entrance')
...
class Lot(models.Model):
    ...
    """
    lot_type = models.CharField(max_length=20, choices=LOT_TYPE, verbose_name='Type')
...
class Apartment(models.Model):
    ...
    entrance = models.ForeignKey(Entrance, on_delete=models.CASCADE, related_name='entrance_apartment')
    parking_space_zone = models.ForeignKey(Zone, on_delete=models.CASCADE, related_name='parking_space_zone')
